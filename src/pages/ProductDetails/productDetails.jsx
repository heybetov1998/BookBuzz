                    ...
                    <div className="row">
                        ...
                        <div className={`col-md-6 ${styles.product}`}>
                            ...
                            <p className="overview">
                                ...
                                adipisicing elit. Quaerat necessitatibus cum in
                                excepturi modi error iusto dolores aperiam,
                                sapiente praesentium, ullam fugit neque? Libero
                                ullam maiores adipisci eligendi quo corporis
                                eum, natus, facere omnis, porro voluptates.
                                Facere facilis ut quasi incidunt nam omnis earum
                                soluta aliquam quo? Corporis, iure culpa!
                            </p>
                            <div className="tags">
                                <Tag />
                                <Tag />
